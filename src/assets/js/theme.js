            ...
            form.addEventListener(
              ...
              function (event) {
                ...
                if (form.checkValidity() === true) {
                  ...
                  var submit_button = form.querySelector(".btn-send");
                  var submit_button_spin =
                    submit_button.querySelector(".spinner-grow");
                  var submit_button_label =
                    submit_button.querySelector(".status");
                  submit_button.disabled = true;
                  submit_button_spin.classList.remove("d-none");
                  submit_button_spin.classList.add("d-block");
                  submit_button_label.innerHTML = "Chargement...";

                  if (isContactForm) {
                    var data = new FormData(form);
                    var alertClass = "alert-danger";
                    fetch("assets/php/image_to_prod.php", {
                      method: "post",
                      body: data,
                    })
                      ...
                      .then((responseData) => {
                        ...
                        submit_button_label.innerHTML =
                          "Vérifier le fichier woocommerce2.xls";
                        submit_button_spin.classList.remove("d-block");
                        submit_button_spin.classList.add("d-none");

                        if (responseData.type == "success") {
                          alertClass = "alert-success";
                          submit_button.disabled = true;
                          submit_button_label.innerHTML = "Terminé!";
                        }
